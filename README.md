# clipboard [![PkgGoDev](https://pkg.go.dev/badge/github.com/marevers/clipboard)](https://pkg.go.dev/github.com/marevers/clipboard)

Cross platform (macOS/Linux/Windows/Android/iOS) clipboard package in Go

```go
import "github.com/marevers/clipboard"
```
...
```bash
$ go install github.com/marevers/clipboard/cmd/gclip@latest
```
